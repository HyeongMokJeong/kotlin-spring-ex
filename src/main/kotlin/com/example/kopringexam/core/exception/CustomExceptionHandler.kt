package com.example.kopringexam.core.exception

import com.example.kopringexam.core.response.ErrorResponse
...
class CustomExceptionHandler {
    ...
    protected fun invalidInputException(ex: InvalidInputException) : ResponseEntity<ErrorResponse> {
        val errors = ErrorResponse(ex.message ?: "No Exception Message", null, 400)
